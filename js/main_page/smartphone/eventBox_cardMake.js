...
var makeEventCardsFn = function(img_description, title, contents, img_png, img_svg){
  ...
  makeDiv.innerHTML = '<div role="img" alt='+ img_description +' class="eventBox_card_wrap" aria-label='+ img_description +' tabindex="0"><div class="eventBox_img_area"></div><div class="eventBox_content_area"><h3 class="eventBox_card_title">'+ title +'</h3><p class="eventBox_card_contents" tabindex="0">'+ contents +'</p><button type="button" class="eventBox_card_viewbtn">자세히보기</button><button type="button" class="eventBox_card_joinbtn">참여하기</button></div></div>'
