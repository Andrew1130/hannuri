...
var makeIntroCardFn = function(img_description, title, contents, img_png, img_svg) {
  ...
  makeDiv.innerHTML = '<div class="introBox_contents" role="img" alt='+ img_description +' aria-label='+ img_description +' tabindex="0"><h3 class="introBox_card_title">'+ title +'</h3><p class="introBox_card_contents" tabindex="0">'+ contents +'</p><button type="button" class="introBox_card_btn">자세히보기</button></div>'
